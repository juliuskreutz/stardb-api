//! Genshin population-percentile persistence and pool-specific routing. This module targets the standard pool.
...
pub async fn set_bulk(stats: &[DbWishesStatGlobal], pool: &PgPool) -> Result<()> {
    ...
    sqlx::query_file!(
        "sql/gi/wishes_stats_global/standard/set_bulk.sql",
        &uids,
        &count,
        &luck_4,
        &luck_5,
