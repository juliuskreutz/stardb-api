//! Genshin population-percentile persistence and pool-specific routing. This module targets the chronicled pool.
...
pub async fn set_bulk(stats: &[DbWishesStatGlobal], pool: &PgPool) -> Result<()> {
    ...
    sqlx::query_file!(
        "sql/gi/wishes_stats_global/chronicled/set_bulk.sql",
        &uids,
        &count,
        &luck_4,
        &luck_5,
