INSERT INTO warps_stats_global_collab (uid, count_percentile, luck_4_percentile, luck_5_percentile)
SELECT *
FROM UNNEST(
    $1::integer[],         -- uid
...
WHERE (warps_stats_global_collab.count_percentile, warps_stats_global_collab.luck_4_percentile, warps_stats_global_collab.luck_5_percentile)
