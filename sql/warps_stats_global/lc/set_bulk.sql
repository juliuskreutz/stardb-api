INSERT INTO warps_stats_global_lc (uid, count_percentile, luck_4_percentile, luck_5_percentile)
SELECT *
FROM UNNEST(
    $1::integer[],         -- uid
...
WHERE (warps_stats_global_lc.count_percentile, warps_stats_global_lc.luck_4_percentile, warps_stats_global_lc.luck_5_percentile)
