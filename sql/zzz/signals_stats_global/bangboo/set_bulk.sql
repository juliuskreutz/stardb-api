INSERT INTO zzz_signals_stats_global_bangboo (uid, count_percentile, luck_a_percentile, luck_s_percentile)
SELECT *
FROM UNNEST(
    $1::integer[],
    $2::double precision[],
...
WHERE (zzz_signals_stats_global_bangboo.count_percentile, zzz_signals_stats_global_bangboo.luck_a_percentile, zzz_signals_stats_global_bangboo.luck_s_percentile)
