...
WHERE (zzz_signals_stats_global_w_engine.count_percentile, zzz_signals_stats_global_w_engine.luck_a_percentile, zzz_signals_stats_global_w_engine.luck_s_percentile)
