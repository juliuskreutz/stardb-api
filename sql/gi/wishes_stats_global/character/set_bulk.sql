INSERT INTO gi_wishes_stats_global_character (uid, count_percentile, luck_4_percentile, luck_5_percentile)
SELECT *
FROM UNNEST(
    $1::integer[],
    $2::double precision[],
...
WHERE (gi_wishes_stats_global_character.count_percentile, gi_wishes_stats_global_character.luck_4_percentile, gi_wishes_stats_global_character.luck_5_percentile)
